...
define([
    ...
    function load(url, options) {
        ...
        return loadWithXhr.load(url, responseType, method, data, headers, overrideMimeType);
    }
    ...
    loadWithXhr.load = function(url, responseType, method, data, headers, overrideMimeType) {
